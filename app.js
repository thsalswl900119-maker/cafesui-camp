...
const LESSON={1:`<div class="lesson"><h5>원가와 손익, 쉽게 — 먼저 읽고 시작</h5>
...
<p><b>손익은 네 줄</b> — 매출 − 매출원가(재료·포장) − 고정비(월세·인건비·보험) − 변동비(공과금·수수료·광고) = 영업이익.</p></div>`,
2:`<div class="lesson"><h5>브랜딩 기초 — 먼저 읽고 시작</h5>
...
<p><b>마케팅은 이 순서로</b> — ① 첫 손님 10명을 기억에 남게 대접 ② 그 손님이 친구에게 할 한 문장 만들기 ③ 리뷰 부탁(스마트플레이스·인스타) ④ 인스타는 주제 3개로 꾸준히(팔로워보다 저장·DM) ⑤ 광고는 마지막에 소액으로.</p></div>`,
3:`<div class="lesson"><h5>상권을 조사하는 사이트 세 곳 — 쓰는 법</h5>
...
<p><b>세 곳을 다 보고 나면</b> 이렇게 한 줄이 나옵니다 — "명지동은 저녁 6~8시에 30~40대가 가장 많이 지나가고, 이들이 찾는 말은 「명지카페」(월 1,200회)·「명지 케이크」(월 380회)인데 케이크 전문점은 아직 없다." 이 한 줄이 아래 칸들의 답입니다.</p></div>`};
